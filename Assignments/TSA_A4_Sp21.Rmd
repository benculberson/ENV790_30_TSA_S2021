...
```
After differencing these plots with a lag of 1, all three time series seem to have lost their series. They now seem to be stationary plots. However, all three series continue to have a seasonal trend (as we did not difference at lag=12). Still, this differencing does drastically alter our time series plots from their non-differenced plots. 
