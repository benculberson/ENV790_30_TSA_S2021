...
decompose_raw_inflow_data=decompose(ts_inflow_data[,15], "additive") 
plot(decompose_raw_inflow_data)
```
...
decompose_HP_15_adj<-seasadj(decompose_raw_inflow_data)
plot(decompose_HP_15_adj)
