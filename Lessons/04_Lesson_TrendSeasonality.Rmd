...
```{r}
ts_inflow_data <- ts(inflow_data[,2:(2+nhydro-1)],frequency=12) #this should still be 15 columns frequency = 12 means this data is monthly (eery 12 observations you go back to the same month)
