...
2. Go over key takeaways from A5
...
```{r}
#Perhaps just one of the models that we looked at in the module 
#the arithmetic mean from the module? - no, not when we have a trend
#the naive method? The ARIMA only method
...
```{r}
#SARIMA or seasonal naive method 
