...
#Obviously I do not have this above file path on my machine

#Show alternative way of doing it with relative path-this is the way
raw_inflow_data <- read.table(file="../Data/inflowtimeseries.txt",header=FALSE,skip=0)

#above, use the dots needed to get to your relative pathway (2 dots in this case), press slash and then tab which will allow you to select the folder you want-this way we can get the Data folder and the data set we want 

#in r we index from 1
...
nhydro <- ncol(raw_inflow_data)-2 #clearly is just 5-2=3, just removing data info
