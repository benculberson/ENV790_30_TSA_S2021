...
ARIMA_temp <- auto.arima(BR_Temp_ts_deseas, max.P = 0, max.Q = 0, max.D = 0)
print(ARIMA_temp)
...
ARIMA_for <- forecast(ARIMA_temp,h=12)
ARIMA_scores <- accuracy(ARIMA_for)
plot(ARIMA_for)
ARIMA_scores
...
ARIMA.df<-data.frame(ARIMA_scores)
